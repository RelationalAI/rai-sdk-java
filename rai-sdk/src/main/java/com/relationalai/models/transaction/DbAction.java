...
public class DbAction extends HashMap<String, Object> {
    DbAction() {}
    ...
    public static DbAction makeInstallAction(Map<String, String> models) {
        int i = 0;
    ...
    public static DbAction makeQueryAction(String source, Map<String, String> inputs) {
